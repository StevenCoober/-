...
<!--           <el-form-item label="会员" :label-width="formLabelWidth" prop="member_id">
    ...
    <div slot="footer" style="text-align: right;" class="dialog-footer">
      ...
      <el-dialog title="访客" :modal-append-to-body="false"  :visible.sync="tinymceDialogFormVisible" width="100%">
        <template>
...
export default {
  ...
  data() {
    ...
    */
     ...
     */
    OnClickCancleForm() {
      xxevent.emit("EditDialogShow_Visitor", false); // 新增或编辑界面显示
    },
    ...
    async OnClickOkForm() {
      ...
      if (res.errno == 0) {
        ...
        xxevent.emit("SendUpdateItem_Visitor", res.data); // 更新单个数据项
      }
