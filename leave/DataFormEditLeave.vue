<template>
  <div>
    <el-form :model="editTableData" :rules="rules" ref="editTableData">
          <el-form-item  v-show="!editTableDataNew" label="健身房请假id" :label-width="formLabelWidth" prop="id">
              <el-input placeholder="请输入健身房请假id" type="number" :disabled="true" v-model="editTableData.id"></el-input>
          </el-form-item>
