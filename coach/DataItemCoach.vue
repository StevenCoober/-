  ...
  <div class="un-handle-layout">
      ...
      <div class="un-handle-content">
        <el-row :gutter="20">
          ...
          <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">微信用户:</span>
              <span class="color-danger">{{data.user_name}}</span>
            </div>
          </el-col>
          <el-col :span="8">
            <div class="un-handle-item">
          ...
          <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">特长:</span>
              <span class="color-danger">{{data.skill}}</span>
            </div>
          </el-col>
          <el-col :span="24">
            <div class="un-handle-item">
...
<!--           <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">浏览量:</span>
              <span class="color-danger">{{data.views}}</span>
            </div>
          </el-col> -->
          <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">排序:</span>
              <span class="color-danger">{{data.paixu}}</span>
            </div>
          </el-col>
<!--           <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">是否是明星教练:</span>
              <span class="color-danger">{{data.is_star}}</span>
            </div>
          </el-col> -->
          <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">是否是明星教练:</span>
              <span class="color-danger">{{['否', '是'][data.is_star]}}</span>
            </div>
          </el-col>
          <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">性别:</span>
              <span class="color-danger">{{["无性别", "男", "女"][data.gender]}}</span>
            </div>
          </el-col>
        </el-row>
      </div>
...
export default {
  ...
  methods: {
    async onSendUpdateItem_Coach(item) {
