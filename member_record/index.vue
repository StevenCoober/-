...
<el-button type="primary" icon="el-icon-search" @click="()=>{currentPage=1; this.FetchIndexList()}">查询</el-button>
        ...
        <!--新增按钮-->
        <el-button @click="OnClickAddItem" type="success" icon="el-icon-plus">新增会员用户录入</el-button>
              ...
              <template slot-scope="props">
                <el-form label-position="left" inline class="demo-table-expand">
                  ...
                  <el-form-item label="身份证" style="width:100%;">
                    <span>{{props.row.identity_card}}</span>
                  </el-form-item>
                  <el-form-item label="生活照" style="width:100%;">
                    <span>{{props.row.life_photo}}</span>
                  </el-form-item>
                </el-form>
              </template>
            </el-table-column>
      ...
      <!--Edit It Begin -->
      <el-dialog title="会员用户录入" :visible.sync="dialogFormVisible">
...
>
      ...
      <!--Edit It End -->
      <el-dialog title="会员用户录入" :visible.sync="tinymceDialogFormVisible" width="100%">
        <template>
...
export default {
  ...
  methods: {
    ...
    async FetchIndexList() {
      ...
      //   url: "/admin/member_record/all",
      //   method: "post"
      // });
      // if (res_all["data"] != null) {
      //   for (let i = 0; i < res_all["data"].length; i++) {
      //     const data = res_all["data"][i]; // 会员用户录入
