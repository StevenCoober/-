  ...
  <div class="app-container">
    <div class="filter-container">
      <el-form :inline="true" class="demo-form-inline">
        ...
        <!--新增按钮-->
        <el-button @click="OnClickAddItem" icon="el-icon-plus" type="success">新增健身房文章</el-button>
        ...
        <template>
          ...
          >
            ...
            <el-table-column type="expand">
              <template slot-scope="props">
                <el-form label-position="left" inline class="demo-table-expand">
                  <el-form-item label="健身房文章id" style="width:100%;">
                    <span>{{props.row.id}}</span>
                  </el-form-item>
                  <el-form-item label="健身房文章标题" style="width:100%;">
                    <span>{{props.row.title}}</span>
                  </el-form-item>
                  <el-form-item label="健身房文章缩略图" style="width:100%;">
              <image-cropper-more :single="false" v-model="props.row.article_img" :disabled="true"></image-cropper-more>
                  </el-form-item>
                  <el-form-item label="文章所属种类" style="width:100%;">
                    <span>{{props.row.article_type}}</span>
                  </el-form-item>
                  <el-form-item label="浏览量" style="width:100%;">
                    <span>{{props.row.view_count}}</span>
                  </el-form-item>
                  <el-form-item label="健身房文章内容" style="width:100%;">
            ...
            <!--++隐藏的项++-->
            <!--++显示的项++-->
            <el-table-column label="健身房文章id" prop="id"></el-table-column>
            <el-table-column label="健身房文章标题" prop="title"></el-table-column>
            <!-- <el-table-column label="健身房文章缩略图" prop="article_img">
              <template slot-scope="props">
                <image-cropper-more :single="true" v-model="props.row.article_img" :disabled="true"></image-cropper-more>
              </template>
            </el-table-column> -->
            <el-table-column label="文章所属种类" prop="article_type"></el-table-column>
      ...
      <!--Edit It Begin -->
      <el-dialog title="健身房文章" :visible.sync="dialogFormVisible">
...
>
          ...
          <el-form-item label="健身房文章缩略图(500x219)" :label-width="formLabelWidth" prop="article_img">
                      <image-cropper-more :single="true" v-model="editTableData.article_img" :disabled="false"></image-cropper-more>
          </el-form-item>
          ...
          <el-form-item label="健身房文章内容" :label-width="formLabelWidth">
            ...
            <el-button type="primary" icon="el-icon-edit" @click= "tinymceDialogFormVisible=true;pushKeyForEditTableDataTinymce('detail');">编辑</el-button>
          </el-form-item>
      ...
      <!--Edit It End -->
      <el-dialog title="健身房文章" :visible.sync="tinymceDialogFormVisible" width="100%">
        <template>
...
export default {
  ...
  methods: {
    ...
    async FetchList() {
      ...
      //     const data = res_all["data"][i]; // 健身房文章
