  ...
  <div class="app-container">
    <div class="filter-container">
      <el-form :inline="true" class="demo-form-inline">
        ...
        <!--新增按钮-->
        <el-button @click="OnClickAddItem" icon="el-icon-plus" type="success">新增会员用户</el-button>
        ...
        <template>
          ...
          >
              ...
              <template slot-scope="props">
                <el-form label-position="left" inline class="demo-table-expand">
                  ...
                  <el-form-item label="生活照" style="width:100%;">
                    <image-cropper-more :single="false" v-model="props.row.life_photo" :disabled="true"></image-cropper-more>
                  </el-form-item>
                  <el-form-item label="顾问id" style="width:100%;">
                    <span>{{props.row.adviser_id}}</span>
                  </el-form-item>
                </el-form>
              </template>
            </el-table-column>
            ...
            <!--++隐藏的项++-->
            <!--++显示的项++-->
            <el-table-column label="会员用户id" prop="id"></el-table-column>
      ...
      <!--Edit It Begin -->
      <el-dialog title="会员用户" :visible.sync="dialogFormVisible">
...
>
      ...
      <!--Edit It End -->
      <el-dialog title="会员用户" :visible.sync="tinymceDialogFormVisible" width="100%">
        <template>
...
export default {
  ...
  methods: {
    ...
    async FetchList() {
      ...
      //     const data = res_all["data"][i]; // 会员用户
