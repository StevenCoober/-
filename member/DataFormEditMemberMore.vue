    ...
    <el-form :model="editTableData" :rules="rules" ref="editTableData">
          ...
          <el-form-item label="性别" :label-width="formLabelWidth" prop="gender">
            <el-select v-model="editTableData.gender" class="filter-item">
              ...
              <!-- <el-input placeholder="请输入性别" v-model="editTableData.gender"></el-input> -->
          </el-form-item>
...
export default {
  ...
  data() {
   ...
   methods: {
     ...
     */
    OnClickCancleForm() {
      xxevent.emit("EditDialogShow_MemberMore", false); // 新增或编辑界面显示
    },
