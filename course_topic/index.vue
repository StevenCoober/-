  ...
  <div class="app-container">
    <div class="filter-container">
      <el-form :inline="true" class="demo-form-inline">
        ...
        <!--新增按钮-->
        <el-button @click="OnClickAddItem" icon="el-icon-plus" type="success">新增课程主题</el-button>
        ...
        <template>
          ...
          >
            ...
            <el-table-column type="expand">
              <template slot-scope="props">
                <el-form label-position="left" inline class="demo-table-expand">
                  ...
                  <el-form-item label="详细名称" style="width: 100%;">
                    <span>{{props.row.name}}</span>
                  </el-form-item>
                  <el-form-item label="顶部导航" style="width:100%;">
                    <image-cropper-more v-model="props.row.top_ad" :disabled="true"></image-cropper-more>
                  </el-form-item>

                  <el-form-item label="教练" style="width: 100%;">
                    <span>{{coachOptions[props.row.coach_id]}}</span>
                  </el-form-item>
                  <el-form-item label="课程主题类型" style="width: 100%;">
                    <span>{{courseOptions[props.row.topic_type_id]}}</span>
                  </el-form-item>
                  <el-form-item label="简介" style="width: 100%;">
                    <span style="white-space: pre-line;">{{props.row.desc}}</span>
                  </el-form-item>
                  <el-form-item label="创建时间" style="width: 100%;">
                    <el-icon name="time"></el-icon>
                    <span>{{props.row.add_time}}</span>
                  </el-form-item>
                  <el-form-item label="节数" style="width: 100%;">
                    <span>{{props.row.class_num}}</span>
                  </el-form-item>
                  <el-form-item label="金额" style="width: 100%;">
                    <span>{{props.row.class_price}}</span>
                  </el-form-item>
            ...
            <!--++隐藏的项++-->
            <!--++显示的项++-->
            <el-table-column label="课程主题id" prop="id"></el-table-column>
            <el-table-column label="详细名称" prop="name"></el-table-column>
            <!-- <el-table-column label="顶部导航" prop="top_ad">
              <template slot-scope="props">
                <image-cropper-more :single="false" v-model="props.row.top_ad" :disabled="true"></image-cropper-more>
              </template>
            </el-table-column> -->
            <el-table-column label="教练id" prop="coach_id"></el-table-column>
            <el-table-column label="课程主题类型id" prop="topic_type_id"></el-table-column>
            <!-- <el-table-column style="white-space: pre-line;" label="简介" prop="desc"></el-table-column> -->
            ...
            <el-table-column label="节数" prop="class_num"></el-table-column>
            <el-table-column label="金额" prop="class_price"></el-table-column>
      ...
      <!--Edit It Begin -->
      <el-dialog title="课程主题" :visible.sync="dialogFormVisible">
...
>
          ...
          <el-form-item label="顶部导航(1:1)" :label-width="formLabelWidth" prop="top_ad">
          ...
          <el-form-item label="教练id" :label-width="formLabelWidth" prop="coach_id">
            <el-select  placeholder="请选择教练id" v-model="editTableData.coach_id" class="filter-item">
              <el-option
           ...
           <!-- <el-input type="number" v-model="editTableData.coach_id"></el-input> -->
          </el-form-item>
          <el-form-item label="课程主题类型" :label-width="formLabelWidth" prop="topic_type_id">
            <el-select v-model="editTableData.topic_type_id" class="filter-item">
              <el-option
                v-for="(item, idx) in courseOptions"
                :key="idx"
                :label="item"
                :value="idx"
              />
            </el-select>
            <!-- <el-input type="number" v-model="editTableData.topic_type_id"></el-input> -->
          </el-form-item>
          <el-form-item label="简介" :label-width="formLabelWidth"  prop="desc">
            <el-input
	    	placeholder="请输入简介"
              :autosize="{minRow:3, maxRow:10}"
              type="textarea"
              v-model="editTableData.desc"
            ></el-input>
          </el-form-item>
          ...
          <el-form-item label="详细描述" :label-width="formLabelWidth">
            ...
            <el-button
              type="primary"
              @click="tinymceDialogFormVisible=true;pushKeyForEditTableDataTinymce('detail');"
            >编辑</el-button>
          </el-form-item>
        </el-form>
      ...
      <!--Edit It End -->
      <el-dialog title="课程主题" :visible.sync="tinymceDialogFormVisible" width="100%">
        <template>
  ...
  methods: {
    ...
    async OnClickAddItem() {
      ...
      this.editTableData = {
        ...
        top_ad: "",
        coach_id: null, // 教练id
        topic_type_id: null, // 主题id
        desc: "", // 简介
        add_time: new Date(), // 创建时间
        class_num: 0, // 节数
        class_price: 0.0, // 金额
        detail: "" // 详细描述
      };
     ...
     * @param: row
     */
    async OnClickEditItem(index, row) {
      // await this.GetTypeList();
      this.dialogFormVisible = true;
      this.editTableData = deepClone(row);
      this.editTableData.topic_type_id = "" + this.editTableData.topic_type_id;
      this.editTableData.coach_id = "" + this.editTableData.coach_id;
    ...
    async OnClickDeleteItem(index, row) {
      ...
      let res = await this.request({
        url: "/admin/course_topic/delete",
        data: { id: row.id }, // 课程主题id
        method: "post"
      });
      if (res.errno == 0) {
    ...
    async GetCoachList() {
      ...
      if (res_all["data"] != null) {
        ...
        for (let i = 0; i < res_all["data"].length; i++) {
          ...
          const user_id = data.user_id; // 用户id
        ...
        console.log("this.coachOptions", tbl);
        this.coachOptions = tbl;
      }
    },
