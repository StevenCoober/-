  ...
  <div class="app-container">
    <div class="filter-container">
      <el-form :inline="true" class="demo-form-inline">
        ...
        <!--新增按钮-->
        <el-button @click="OnClickAddItem" icon="el-icon-plus" type="success">新增课程主题类型</el-button>
        ...
        <template>
          ...
          >
            ...
            <el-table-column type="expand">
              <template slot-scope="props">
                <el-form label-position="left" inline class="demo-table-expand">
                  <el-form-item label="课程主题类型id" style="width:100%;">
                    <span>{{props.row.id}}</span>
                  </el-form-item>
                  <el-form-item label="类型名称, 比如瘦身课" style="width:100%;">
            ...
            <!--++隐藏的项++-->
            <!--++显示的项++-->
            <el-table-column label="课程主题类型id" prop="id"></el-table-column>
            <el-table-column label="类型名称, 比如瘦身课" prop="type_name"></el-table-column>
      ...
      <!--Edit It Begin -->
      <el-dialog title="课程主题类型" :visible.sync="dialogFormVisible">
...
>
      ...
      <!--Edit It End -->
      <el-dialog title="课程主题类型" :visible.sync="tinymceDialogFormVisible" width="100%">
        <template>
  ...
  methods: {
    ...
    async OnClickDeleteItem(index, row) {
      ...
      let res = await this.request({
        url: "/admin/course_topic_type/delete",
        data: { id: row.id}, // 课程主题类型id
        method: "post"
      });
      if (res.errno == 0) {
    ...
    async FetchList() {
      ...
      let res = await this.request({
        url: "/admin/course_topic_type/index",
        data: data,
        method: "post"
      });
