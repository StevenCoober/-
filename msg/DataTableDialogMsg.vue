<template>
  ...
  >
    ...
    <el-col :span="24" class="toolbar" style="text-align:left">
      ...
      <!--新增按钮-->
      <el-button @click="OnClickNewItem" icon="el-icon-plus"  type="success">新增消息</el-button>
    </el-col>
...
export default {
  ...
  methods: {
    OnClickQuery() {
      xxevent.emit("SendQueryTableItem_Msg", this.queryItemKey, this.queryItemName); // 查询数据项
    },
