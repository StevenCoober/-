  ...
  <div class="app-container">
    <div class="filter-container">
      <el-form :inline="true" class="demo-form-inline">
        ...
        <!--新增按钮-->
        <el-button @click="OnClickAddItem" type="success" icon="el-icon-plus">新增顾问</el-button>
            ...
            <el-table-column type="expand">
              <template slot-scope="props">
                <el-form label-position="left" inline class="demo-table-expand">
                  <el-form-item label="顾问id" style="width:100%;">
...
<!--                   <el-form-item label="微信用户id" style="width:100%;">
            ...
            <!--++隐藏的项++-->
            <!--++显示的项++-->
            <el-table-column label="顾问id" prop="id">
            </el-table-column>
<!--             <el-table-column label="微信用户id" prop="user_id">
            </el-table-column> -->
            <el-table-column label="微信用户" prop="user_name">
            </el-table-column>
      ...
      <!--Edit It Begin -->
      <el-dialog title="顾问" :visible.sync="dialogFormVisible">
        <el-form :model="editTableData" :rules="rules" ref="editTableData"
>
          <el-form-item  v-show="!editTableDataNew" label="顾问id" :label-width="formLabelWidth" prop="id">
              <el-input placeholder="请输入顾问id" type="number" :disabled="true" v-model="editTableData.id"></el-input>
          </el-form-item>
...
<!--           <el-form-item label="性别" :label-width="formLabelWidth" prop="gender">
      ...
      <!--Edit It End -->
      <el-dialog title="顾问" :visible.sync="tinymceDialogFormVisible" width="100%">
        <template>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        id: [
          { required: true, message: "请输入顾问id", trigger: "blur" },
        ],
        user_id: [
  ...
  methods: {
    ...
    async FetchIndexList() {
      ...
      //     const data = res_all["data"][i]; // 顾问
      //     const id = data.id; // 顾问id
