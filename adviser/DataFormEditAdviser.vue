<template>
  <div>
    ...
    <div slot="footer" style="text-align: right;" class="dialog-footer">
      ...
      <el-dialog title="顾问" :modal-append-to-body="false"  :visible.sync="tinymceDialogFormVisible" width="100%">
        <template>
...
export default {
  ...
  data() {
    ...
    */
     ...
     */
    OnClickCancleForm() {
      xxevent.emit("EditDialogShow_Adviser", false); // 新增或编辑界面显示
    },
