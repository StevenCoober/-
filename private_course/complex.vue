<template>
  <div class="app-container">
    <el-input v-model="query_item_private_course" style="width:auto;" :placeholder="'请输入姓名'"></el-input>
    <el-button type="primary" icon="el-icon-search" @click="OnQueryPrivate_CourseClick">查询</el-button>
    <el-button type="success" icon="el-icon-plus" @click="OnNewPrivate_CourseBtnClick">新增私教课购买</el-button>
    <!-- 单数据 | 私教课购买 | -->
    <DataItemPrivateCourse :odata="data_private_course"></DataItemPrivateCourse>
    
    <!-- 多数据窗口 | 私教课购买 | -->
    <DataTableDialogPrivateCourse>
      <DataTablePrivateCourse :oqueryItemKey="query_key_private_course" :oqueryItemName="query_item_private_course || ''" @select="OnSelectTablePrivate_Course"></DataTablePrivateCourse>
    </DataTableDialogPrivateCourse>
      ...
      <el-tab-pane label="私教课购买" name="first">
        <el-container>
          <el-aside width="100%" style="background-color: rgb(238, 241, 246)">
            ...
            <!-- <DataTablePrivateCourse :oqueryItemKey="query_key_private_course" :oqueryItemName="data_private_course.id == null ? '':data_private_course.id + ''" @select="OnSelectTablePrivate_Course"></DataTablePrivateCourse> -->
          </el-aside>
        </el-container>
      </el-tab-pane>
    </el-tabs>
