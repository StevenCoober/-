...
<el-button type="primary" icon="el-icon-search" @click="()=>{currentPage=1; this.FetchIndexList()}">查询</el-button>
        ...
        <!--新增按钮-->
        <el-button @click="OnClickAddItem" type="success" icon="el-icon-plus">新增私教课购买</el-button>
        ...
        <template>
          ...
          >
            ...
            <el-table-column type="expand">
              <template slot-scope="props">
                <el-form label-position="left" inline class="demo-table-expand">
                  <el-form-item label="私教课购买id" style="width:100%;">
                  ...
                  <el-form-item label="私教课id(教练特长id)" style="width:100%;">
            ...
            <!--++隐藏的项++-->
            <!--++显示的项++-->
            <el-table-column label="私教课购买id" prop="id">
            </el-table-column>
            <el-table-column label="会员卡id" prop="member_card_id">
            </el-table-column>
            <el-table-column label="教练id" prop="coach_id">
            </el-table-column>
            <el-table-column label="私教课id(教练特长id)" prop="course_id">
            </el-table-column>
      ...
      <!--Edit It Begin -->
      <el-dialog title="私教课购买" :visible.sync="dialogFormVisible">
...
>
      ...
      <!--Edit It End -->
      <el-dialog title="私教课购买" :visible.sync="tinymceDialogFormVisible" width="100%">
        <template>
  ...
  methods: {
    ...
    async OnClickDeleteItem(index, row) {
      ...
      let res = await this.request({
        url: "/admin/private_course/delete",
        data: { id: row.id}, // 私教课购买id
        method: "post"
      });
      if (res.errno == 0) {
    ...
    async FetchIndexList() {
      ...
      let res = await this.request({
        url: "/admin/private_course/index",
        data: data,
        method: "post"
      });
