  ...
  <div class="app-container">
    <div class="filter-container">
      <el-form :inline="true" class="demo-form-inline">
        ...
        <!--新增按钮-->
        <el-button @click="OnClickAddItem" icon="el-icon-plus" type="success">新增广告位</el-button>
        ...
        <template>
          ...
          >
            ...
            <el-table-column type="expand">
              <template slot-scope="props">
                <el-form label-position="left" inline class="demo-table-expand">
                  <el-form-item label="广告位id" style="width:100%;">
                    <span>{{props.row.id}}</span>
                  </el-form-item>
                  <el-form-item label="图片地址" style="width:100%;">
                    <el-card class="box-card">
                      <div class="component-item">
                        <img v-if="props.row.pic_url" :src="props.row.pic_url" class="banner">
                      </div>
                    </el-card>
                  </el-form-item>
                  <el-form-item label="广告图片类型"  style="width:100%;">
                    <span>{{banners[props.row.type]}}</span>
                  </el-form-item>
            ...
            <!--++隐藏的项++-->
            <!--++显示的项++-->
            <el-table-column label="广告位id" prop="id"></el-table-column>
            <el-table-column label="图片地址2" width="320px" prop="pic_url">
              <template slot-scope="props">
                <div class="component-item">
                  <img v-if="props.row.pic_url" height="240px" :src="props.row.pic_url">
                </div>
              </template>
            </el-table-column>
            <el-table-column label="广告图片类型">
              <template slot-scope="props">
                <span>{{banners[props.row.type]}}</span>
              </template>
            </el-table-column>
      ...
      <!--Edit It Begin -->
      <el-dialog title="广告位" :visible.sync="dialogFormVisible">
...
>
          ...
          <el-form-item label="图片地址" :label-width="formLabelWidth" prop="pic_url">
            <div class="component-item">
              <image-cropper-more :single="true" v-model="editTableData.pic_url" :disabled="false"></image-cropper-more>
            </div>
          </el-form-item>
          <el-form-item label="广告图片类型" :label-width="formLabelWidth"  prop="type">
            <el-radio
	             placeholder="请选择广告图片类型ad, env"
              v-for="(val, key) in bannersDesc"
              :label="key"
              :key="key"
              v-model="editTableData.type"
            >{{val}}</el-radio>

            <!-- <el-radio v-model="editTableData.type" label="ad">首页头部广告</el-radio>
              <el-radio v-model="editTableData.type" label="env">首页中部广告</el-radio>
            <el-radio v-model="editTableData.type" label="course-env">课程头部广告</el-radio>-->
          </el-form-item>
          ...
          <!-- <el-form-item label="说明" :label-width="formLabelWidth"  prop="desc">
            <el-input v-model="editTableData.desc"></el-input>
          </el-form-item> -->
        </el-form>
      ...
      <!--Edit It End -->
      <el-dialog title="广告位" :visible.sync="tinymceDialogFormVisible" width="100%">
        <template>
...
export default {
  ...
  methods: {
    ...
    async FetchList() {
      ...
      //     const data = res_all["data"][i]; // 广告位
      //     const id = data.id; // 广告位id
      //     const pic_url = data.pic_url; // 图片地址
      //     const type = data.type; // 广告图片类型ad, env
      //     const paixu = data.paixu; // 排序
      //     const desc = data.desc; // 说明
      //   }
      // }
      this.loading = true;
