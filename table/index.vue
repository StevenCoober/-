<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-dialog title="人员" :visible.sync="dialogFormVisible">
        <el-form :model="editTableData">
          ...
          <el-form-item label="是否删除" :label-width="formLabelWidth">
            <el-input type="number" v-model="editTableData.is_delete"></el-input>
          </el-form-item>
      ...
      <el-dialog title="User" :visible.sync="dialogFormEditVisible" width="100%">
        <template>
    ...
    async FetchList() {
      ...
      if (res["data"] != null) {
        ...
        for (let i = 0; i < resData["data"].length; i++) {
          ...
          const edit_text = data.edit_text; // 文章
        }
