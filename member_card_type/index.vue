  ...
  <div class="app-container">
    <div class="filter-container">
      <el-form :inline="true" class="demo-form-inline">
        ...
        <!--新增按钮-->
        <el-button @click="OnClickAddItem" icon="el-icon-plus" type="success">新增会员卡类型</el-button>
        ...
        <template>
          ...
          >
            ...
            <el-table-column type="expand">
              <template slot-scope="props">
                <el-form label-position="left" inline class="demo-table-expand">
                  ...
                  <el-form-item label="会员卡名称" style="width:100%;">
                    <span>{{props.row.card_name}}</span>
                  </el-form-item>
                  <el-form-item label="会员卡图片" style="width:100%;">
              <image-cropper-more :single="true" v-model="props.row.card_img" :disabled="true"></image-cropper-more>
                  </el-form-item>
                  <el-form-item label="会员卡描述" style="width:100%;">
                    <span style="white-space: pre-line;">{{props.row.card_desc}}</span>
                  </el-form-item>
                  <el-form-item label="会员卡详细描述" style="width:100%;">
                    <span style="white-space: pre-line;">{{props.row.card_detail}}</span>
                  </el-form-item>
                </el-form>
              </template>
            </el-table-column>
            ...
            <!--++隐藏的项++-->
            <!--++显示的项++-->
            <el-table-column label="会员卡类型id" prop="id"></el-table-column>
            <el-table-column label="会员卡名称" prop="card_name"></el-table-column>
            <el-table-column label="会员卡图片" prop="card_img">
              <template slot-scope="props">
                <image-cropper-more :single="true" v-model="props.row.card_img" :disabled="true"></image-cropper-more>
              </template>
            </el-table-column>
            <el-table-column style="white-space: pre-line;" label="会员卡描述" prop="card_desc"></el-table-column>
            <el-table-column style="white-space: pre-line;" label="会员卡详细描述" prop="card_detail"></el-table-column>
      ...
      <!--Edit It Begin -->
      <el-dialog title="会员卡类型" :visible.sync="dialogFormVisible">
...
>
      ...
      <!--Edit It End -->
      <el-dialog title="会员卡类型" :visible.sync="tinymceDialogFormVisible" width="100%">
        <template>
...
export default {
  ...
  methods: {
    ...
    async FetchList() {
      ...
      //     const data = res_all["data"][i]; // 会员卡类型
