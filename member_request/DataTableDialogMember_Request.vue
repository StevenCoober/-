<template>
  ...
  >
    ...
    <el-col :span="24" class="toolbar" style="text-align:left">
      ...
      <!--新增按钮-->
      <el-button @click="OnClickNewItem" icon="el-icon-plus"  type="success">新增会员用户申请请求</el-button>
    </el-col>
...
export default {
  name: "DataTableDialogMember_Request",
  components: {
    ImageCropper,
    PanThumb,
    Tinymce
  ...
  methods: {
    OnClickQuery() {
      xxevent.emit("SendQueryTableItem_Member_Request", this.queryItemKey, this.queryItemName); // 查询数据项
    },
    ...
    // 查询数据项
    async onSendQueryTableItem_Member_Request(queryItemKey, queryItemName) {
