<template>
  ...
  >
    ...
    <el-col :span="24" class="toolbar" style="text-align:left">
      ...
      <!--新增按钮-->
      <el-button @click="OnClickNewItem" icon="el-icon-plus"  type="success">新增教练申请请求</el-button>
    </el-col>
...
export default {
  name: "DataTableDialogCoach_Request",
  components: {
    ImageCropper,
    PanThumb,
    Tinymce
  ...
  methods: {
    OnClickQuery() {
      xxevent.emit("SendQueryTableItem_Coach_Request", this.queryItemKey, this.queryItemName); // 查询数据项
    },
